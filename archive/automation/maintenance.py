...
def run_maintenance():
    ...
    logger = get_enhanced_logger("maintenance", enable_background_markers=False)
...
def cleanup_old_content():
    ...
    logger = get_enhanced_logger("maintenance_content", enable_background_markers=False)
...
def rotate_log_files():
    ...
    logger = get_enhanced_logger("maintenance_logs", enable_background_markers=False)
...
def optimize_performance():
    ...
    logger = get_enhanced_logger("maintenance_performance", enable_background_markers=False)
...
def run_health_verification():
    ...
    logger = get_enhanced_logger("maintenance_health", enable_background_markers=False)
